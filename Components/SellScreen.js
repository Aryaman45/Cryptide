...
export default function SellScreen({ route }) {
    ...
    const updatePrice = (text) => {
        ...
        if (!isNaN(quantity)) {
            setPrice(quantity * item.coin.current_price);  // Update the price state if input is valid
        } else {
    ...
    const BuyCoin = async () => {
        ...
        try {
          ...
          if (docSnapshot.exists()) {
            ...
            // Add the new data to the current portfolio
            currentPortfolio[newKey] = newData;
        ...
        <SafeAreaView style={{ flex: 1, backgroundColor: "white" }}>
            <View style={{ gap: 50 }} >
                ...
                <View style={styles.EstContainer}>
                    <Text style={{ color: "#a3a3a3", fontSize: 18 }}>Estimated Selling Price</Text>
            ...
            <View style={{ flex: 1, justifyContent: "space-between" }}>
                <View>
                    <View style={styles.container}>
                        ...
                        <Text style={styles.text}>How much do you want to sell?</Text>
                        <View style={styles.line} />
                    </View>
                ...
                <View style={styles.footer}>
                    ...
                    <TouchableOpacity style={styles.solidButton} onPress={BuyCoin}>
                        <Text style={styles.solidButtonText}>Sell</Text>
                    </TouchableOpacity>
                </View>
            </View>
        </SafeAreaView>
...
const styles = StyleSheet.create({
    ...
    solidButton: {
        backgroundColor: 'red', // Solid color
        paddingVertical: 12,
